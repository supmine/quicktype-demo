...
quicktype -s schema schemas/user_schema.json -o entities/UserModels.swift --struct-or-class struct --just-types
quicktype -s schema schemas/user_schema.json -o entities/user_models.go --package UserModels
quicktype -s schema schemas/user_schema.json -o entities/UserModels.kt --framework kotlinx 
